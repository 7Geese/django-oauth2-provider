...
class AuthorizedClient(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL,
                             related_name='oauth2_authorized_client', on_delete=models.CASCADE)
...
class Grant(models.Model):
    ...
    * :attr:`scope`
    """
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="oauth2_grant", on_delete=models.CASCADE)
    client = models.ForeignKey(Client, on_delete=models.CASCADE)
...
class AccessToken(models.Model):
    ...
    * :meth:`get_expire_delta` - returns an integer representing seconds to
        expiry
    """
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="oauth2_access_token", on_delete=models.CASCADE)
...
class RefreshToken(models.Model):
    ...
    * :attr:`expired` - ``boolean``
    """
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="oauth2_refresh_token", on_delete=models.CASCADE)
